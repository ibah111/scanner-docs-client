 ...
 * JavaScript code in this page
 */
!(function webpackUniversalModuleDefinition(A, g) {
  'object' == typeof exports && 'object' == typeof module
    ? (module.exports = g())
    : 'function' == typeof define && define.amd
      ? define('pdfjs-dist/build/pdf.sandbox', [], g)
      : 'object' == typeof exports
        ? (exports['pdfjs-dist/build/pdf.sandbox'] = g())
        : (A['pdfjs-dist/build/pdf.sandbox'] = A.pdfjsSandbox = g());
})(globalThis, () =>
  (() => {
    'use strict';
    var A = [
              ...
              function (A) {
                ...
                i =
                  0 !== i.indexOf('blob:')
                    ...
                    : '';
                var n,
                  o = g.print || console.log.bind(console),
                  s = g.printErr || console.warn.bind(console);
                Object.assign(g, D);
                D = null;
                g.wasmBinary && (n = g.wasmBinary);
                g.noExitRuntime;
                ...
                function z(A, Q, C, E) {
                  ...
                  return (function (A) {
                    0 !== n && v(n);
                    return 'string' === Q ? G(A) : 'boolean' === Q ? !!A : A;
                  })((C = A.apply(null, i)));
                }
                var M,
                  F,
                  ...
                  y =
                    'undefined' != typeof TextDecoder
                      ...
                      : void 0;
                function I(A, g) {
                  for (var Q = g + NaN, C = g; A[C] && !(C >= Q); ) ++C;
                  if (16 < C - g && A.buffer && y)
                    return y.decode(A.subarray(g, C));
                  for (Q = ''; g < C; ) {
                    var E = A[g++];
                    if (128 & E) {
                      var D = 63 & A[g++];
                      if (192 == (224 & E))
                        Q += String.fromCharCode(((31 & E) << 6) | D);
                      else {
                        var i = 63 & A[g++];
                        65536 >
                        (E =
                ...
                var p = [null, [], []],
                  ...
                  f = {
                    a: function (A, g, Q, C) {
                      w(
                        'Assertion failed: ' +
                          ...
                          ', at: ' +
                          [
                            g ? G(g) : 'unknown filename',
                            Q,
                            C ? G(C) : 'unknown function',
                          ],
                      );
                    },
                    d: function () {
                    ...
                    e: function (A, g) {
                      ...
                      c[(g + 24) >> 2] = A.getDay();
                      var Q = new Date(A.getFullYear(), 0, 1);
                      c[(g + 28) >> 2] =
                        ((A.getTime() - Q.getTime()) / 864e5) | 0;
                      ...
                      Q = Q.getTimezoneOffset();
                      c[(g + 32) >> 2] =
                        0 | (C != Q && A.getTimezoneOffset() == Math.min(Q, C));
                    },
                    f: function W(A, g, Q) {
                      W.B ||
                        ((W.B = !0),
                    ...
                    h: (A, Q, C) => {
                      A = G(A);
                      Q = null !== Q ? JSON.parse(G(Q)) : [];
                      try {
                        const C = g.externalCall(A, Q);
                        return C ? X(C) : null;
                      } catch (A) {
                        return (g.HEAPU8[C] = 1), X(A.message);
                      }
                    },
                    g: function (A, g) {
                      A = G(A);
                      let Q;
                      try {
                        Q = window.JSON.parse(A);
                      } catch (g) {
                        Q = A;
                      }
                      0 !== g ? window.alert(A) : window.console.log('DUMP', Q);
                    },
                    j: function (A) {
                      var g = R.length;
                      ...
                      for (var Q = 1; 4 >= Q; Q *= 2) {
                        ...
                        A: {
                          try {
                            t.grow((E - M.byteLength + 65535) >>> 16);
                            ba();
                            var D = 1;
                            break A;
                          } catch (A) {}
                    ...
                    l: function (A, g, Q, C) {
                      Q = `Quickjs -- ${(A = G(A))}: ${(g = G(g))}\n${(Q =
                        G(Q))}`;
                      0 !== C ? window.alert(Q) : window.console.error(Q);
                    },
                  };
                !(function () {
                  function a(A) {
                  ...
                  function d(g) {
                    return (function ka() {
                      ...
                      .then(function (g) {
                        return WebAssembly.instantiate(g, A);
                      })
                      .then(function (A) {
                        return A;
                      })
                      .then(g, function (A) {
                        s('failed to asynchronously prepare wasm: ' + A);
                        w(A);
                      });
                  }
                  var A = { a: f };
                  ...
                  'function' != typeof fetch
                    ...
                    : fetch(S, { credentials: 'same-origin' }).then(
                        function (g) {
                          return WebAssembly.instantiateStreaming(g, A).then(
                            b,
                            function (A) {
                ...
                g.___wasm_call_ctors = function () {
                  return (g.___wasm_call_ctors = g.asm.n).apply(
                    null,
                    arguments,
                  );
                };
                g._evalInSandbox = function () {
                  return (g._evalInSandbox = g.asm.o).apply(null, arguments);
                };
                g._nukeSandbox = function () {
                  return (g._nukeSandbox = g.asm.p).apply(null, arguments);
                };
                g._init = function () {
                  return (g._init = g.asm.q).apply(null, arguments);
                };
                g._commFun = function () {
                  return (g._commFun = g.asm.r).apply(null, arguments);
                };
                g._dumpMemoryUse = function () {
                  return (g._dumpMemoryUse = g.asm.s).apply(null, arguments);
                };
                var m = (g._malloc = function () {
                  return (m = g._malloc = g.asm.t).apply(null, arguments);
                });
                g._free = function () {
                  return (g._free = g.asm.u).apply(null, arguments);
                };
                var x,
                  q = (g.stackSave = function () {
                    return (q = g.stackSave = g.asm.w).apply(null, arguments);
                  }),
                  v = (g.stackRestore = function () {
                    return (v = g.stackRestore = g.asm.x).apply(
                      null,
                      arguments,
                    );
                  }),
                  P = (g.stackAlloc = function () {
                    return (P = g.stackAlloc = g.asm.y).apply(null, arguments);
                  });
                g.ccall = z;
                g.cwrap = function (A, Q, C, E) {
                ...
                function Z() {
                  function a() {
                    if (!x && ((x = !0), (g.calledRun = !0), !h)) {
                      V(N);
                      C(g);
                      g.onRuntimeInitialized && g.onRuntimeInitialized();
                      if (g.postRun)
                        for (
                          'function' == typeof g.postRun &&
                          (g.postRun = [g.postRun]);
                          g.postRun.length;
        ...
        (A, g) => {
          class SandboxSupportBase {
            ...
            destroy() {
              this.commFun = null;
              for (const A of this.timeoutIds.values())
                this.win.clearTimeout(A);
              this.timeoutIds = null;
            }
            exportValueToSandbox(A) {
              throw new Error('Not implemented');
            }
            importValueFromSandbox(A) {
              throw new Error('Not implemented');
            }
            createErrorForSandbox(A) {
              throw new Error('Not implemented');
            }
            callSandboxFunction(A, g) {
              try {
                g = this.exportValueToSandbox(g);
                this.commFun(A, g);
              } catch (A) {
                this.win.console.error(A);
              }
            }
            createSandboxExternals() {
              const A = {
                setTimeout: (A, g) => {
                  if ('number' != typeof A || 'number' != typeof g) return;
                  0 === A && this.win.clearTimeout(this.timeoutIds.get(A));
                  const Q = this.win.setTimeout(() => {
                    this.timeoutIds.delete(A);
                    this.callSandboxFunction('timeoutCb', {
                      callbackId: A,
                      interval: !1,
                    });
                  }, g);
                  this.timeoutIds.set(A, Q);
                },
                clearTimeout: (A) => {
                  this.win.clearTimeout(this.timeoutIds.get(A));
                  this.timeoutIds.delete(A);
                },
                setInterval: (A, g) => {
                  if ('number' != typeof A || 'number' != typeof g) return;
                  const Q = this.win.setInterval(() => {
                    this.callSandboxFunction('timeoutCb', {
                      callbackId: A,
                      interval: !0,
                    });
                ...
                clearInterval: (A) => {
                  this.win.clearInterval(this.timeoutIds.get(A));
                  this.timeoutIds.delete(A);
                },
                alert: (A) => {
                  'string' == typeof A && this.win.alert(A);
                },
                confirm: (A) => 'string' == typeof A && this.win.confirm(A),
                prompt: (A, g) =>
                  'string' != typeof A || 'string' != typeof g
                    ? null
                    : this.win.prompt(A, g),
                parseURL: (A) => {
                  const g = new this.win.URL(A);
                  return Object.fromEntries(
                    [
                      ...
                      'searchParams',
                      'username',
                    ].map((A) => [A, g[A].toString()]),
                  );
                },
                send: (A) => {
                  if (!A) return;
                  const g = new this.win.CustomEvent('updatefromsandbox', {
                    detail: this.importValueFromSandbox(A),
                  });
                  this.win.dispatchEvent(g);
                },
              };
              ...
              return (g, Q) => {
                try {
                  const C = A[g](...Q);
                  return this.exportValueToSandbox(C);
                } catch (A) {
                  throw this.createErrorForSandbox(A?.toString() ?? '');
                }
              };
            }
          }
          g.SandboxSupportBase = SandboxSupportBase;
        },
      ],
      g = {};
    function __w_pdfjs_require__(Q) {
      var C = g[Q];
      if (void 0 !== C) return C.exports;
      var E = (g[Q] = { exports: {} });
      A[Q](E, E.exports, __w_pdfjs_require__);
      return E.exports;
    }
    var Q = {};
    (() => {
      ...
      A.QuickJSSandbox = function QuickJSSandbox() {
        return (0, g.default)().then((A) => new Sandbox(window, A));
      };
      var g = (function _interopRequireDefault(A) {
          return A && A.__esModule ? A : { default: A };
        })(__w_pdfjs_require__(1)),
        C = __w_pdfjs_require__(2);
      class SandboxSupport extends C.SandboxSupportBase {
        exportValueToSandbox(A) {
      ...
      class Sandbox {
        constructor(A, g) {
          this.support = new SandboxSupport(A, this);
          g.externalCall = this.support.createSandboxExternals();
          this._module = g;
        ...
        create(A) {
          ...
          try {
            ...
            g.push(`pdfjsScripting.initSandbox({ data: ${E} })`);
            C = this._module.stringToNewUTF8(g.join('\n'));
            Q = !!this._module.ccall(
              'init',
              'number',
              ['number', 'number'],
              [C, this._alertOnError],
            );
          } catch (A) {
            console.error(A);
          } finally {
            C && this._module.ccall('free', 'number', ['number'], [C]);
          }
          if (!Q) {
            this.nukeSandbox();
        ...
        dispatchEvent(A) {
          this.support?.callSandboxFunction('dispatchEvent', A);
        }
        dumpMemoryUse() {
          this._module && this._module.ccall('dumpMemoryUse', null, []);
        }
        nukeSandbox() {
