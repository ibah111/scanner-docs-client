    ...
    var __webpack_modules__ = [
        ...
        (t, e) => {
          ...
          e.arraysToBytes = function arraysToBytes(t) {
            ...
            let s = 0;
            for (let n = 0; n < e; n++) s += arrayByteLength(t[n]);
            let n = 0;
          ...
          e.stringToPDFString = function stringToPDFString(t) {
            ...
            const e = [];
            for (let s = 0, n = t.length; s < n; s++) {
              const n = r[t.charCodeAt(s)];
              e.push(n ? String.fromCharCode(n) : t.charAt(s));
            }
            return e.join('');
          };
          ...
          e.BaseException = i;
          e.PasswordException = class PasswordException extends i {
            constructor(t, e) {
              super(t, 'PasswordException');
              this.code = e;
            }
          };
          e.UnknownErrorException = class UnknownErrorException extends i {
            constructor(t, e) {
              super(t, 'UnknownErrorException');
              this.details = e;
            }
          };
          e.InvalidPDFException = class InvalidPDFException extends i {
            constructor(t) {
              super(t, 'InvalidPDFException');
            }
          };
          e.MissingPDFException = class MissingPDFException extends i {
            constructor(t) {
          ...
          e.FormatError = class FormatError extends i {
            constructor(t) {
              super(t, 'FormatError');
            }
          };
          e.AbortException = class AbortException extends i {
            constructor(t) {
          ...
          function stringToBytes(t) {
            ...
            const e = t.length,
              s = new Uint8Array(e);
            for (let n = 0; n < e; ++n) s[n] = 255 & t.charCodeAt(n);
            return s;
          }
          ...
          class Util {
            ...
            static getAxialAlignedBoundingBox(t, e) {
              ...
              return [
                Math.min(s[0], n[0], i[0], a[0]),
                Math.min(s[1], n[1], i[1], a[1]),
                Math.max(s[0], n[0], i[0], a[0]),
                Math.max(s[1], n[1], i[1], a[1]),
              ];
            }
            ...
            static intersect(t, e) {
              ...
              if (s > n) return null;
              const i = Math.max(Math.min(t[1], t[3]), Math.min(e[1], e[3])),
                a = Math.min(Math.max(t[1], t[3]), Math.max(e[1], e[3]));
              return i > a ? null : [s, i, n, a];
            }
            static bezierBoundingBox(t, e, s, n, i, a, r, o) {
              const l = [],
                c = [[], []];
              let h, d, u, p, g, m, f, b;
              for (let c = 0; c < 2; ++c) {
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
              ...
              switch (t) {
                case 'url':
                  if ('undefined' != typeof window)
                    try {
                      n[t] = new URL(e, window.location).href;
                      continue;
                    } catch (t) {
                ...
                case 'data':
                  if (
                    ...
                    n[t] = new Uint8Array(e);
                  else {
                    if (e instanceof Uint8Array) break;
                    if ('string' == typeof e)
                      n[t] = (0, _util.stringToBytes)(e);
                    else if (
                      'object' != typeof e ||
                      null === e ||
                      isNaN(e.length)
            ...
            n.StandardFontDataFactory =
              n.StandardFontDataFactory || DefaultStandardFontDataFactory;
            ...
            'boolean' != typeof n.isOffscreenCanvasSupported &&
              (n.isOffscreenCanvasSupported = !_is_node.isNodeJS);
            'boolean' != typeof n.disableFontFace &&
              (n.disableFontFace = _is_node.isNodeJS);
            'boolean' != typeof n.useSystemFonts &&
              (n.useSystemFonts = !_is_node.isNodeJS && !n.disableFontFace);
            ('object' == typeof n.ownerDocument && null !== n.ownerDocument) ||
            ...
            a.promise
              .then(function () {
                ...
                const t = _fetchDocument(a, n, i, r),
                ...
                return Promise.all([t, s]).then(function ([t, s]) {
                  if (e.destroyed) throw new Error('Loading aborted');
                  const i = new _message_handler.MessageHandler(r, t, a.port),
          ...
          async function _fetchDocument(t, e, s, n) {
            ...
            const i = await t.messageHandler.sendWithPromise('GetDocRequest', {
              docId: n,
              apiVersion: '3.2.146',
              data: e.data,
              password: e.password,
          ...
          class PDFPageProxy {
            ...
            render({
              ...
              const d = this._transport.getRenderingIntent(s, n, h);
              this.pendingCleanup = !1;
            ...
            getOperatorList({
              ...
              const n = this._transport.getRenderingIntent(t, e, s, !0);
              let i,
            ...
            getTextContent(t = {}) {
              ...
              return new Promise(function (t, s) {
                ...
                !(function pump() {
                  n.read().then(function ({ value: e, done: s }) {
                    if (s) t(i);
                    else {
                      Object.assign(i.styles, e.styles);
                      i.items.push(...e.items);
                      pump();
                    }
                  }, s);
                })();
            ...
            _pumpOperatorList({
              ...
              const pump = () => {
                n.read().then(
                  ({ value: t, done: e }) => {
                    if (e) i.streamReader = null;
                    else if (!this._transport.destroyed) {
                      this._renderPageChunk(t, i);
                      pump();
                    }
                  },
                  (t) => {
                    ...
                    if (!this._transport.destroyed) {
                      if (i.operatorList) {
                        ...
                        for (const t of i.renderTasks) t.operatorListChanged();
                        this._tryCleanup();
                      }
          ...
          class LoopbackPort {
            ...
            postMessage(t, e) {
              ...
              this.#n.then(() => {
                for (const t of this.#s) t.call(this, s);
              });
            }
          ...
          class WorkerTransport {
            ...
            getRenderingIntent(
              ...
              return {
                renderingIntent: i,
                cacheKey: `${i}_${_annotation_storage.AnnotationStorage.getHash(
                  a,
                )}`,
                ...
                if (!this.destroyed && !this.commonObjs.has(e))
                  switch (s) {
                    case 'Font':
                      ...
                      const r = new _font_loader.FontFaceObject(n, {
                  ...
                  switch (s) {
                    case 'Image':
                      ...
                      if (n) {
                        let t;
                        if (n.bitmap) {
                          const { bitmap: e, width: s, height: a } = n;
                          t = s * a * 4;
                          i._bitmaps.add(e);
                        } else t = n.data?.length || 0;
                        t > e && (i.cleanupAfterRender = !0);
                      }
                      break;
                    case 'Pattern':
                      i.objs.resolve(t, n);
            ...
            getMetadata() {
              return (this.#l ||= this.messageHandler
          ...
          class PDFObjects {
            ...
            has(t) {
              return this.#c[t]?.capability.settled || !1;
            }
            resolve(t, e = null) {
              const s = this.#h(t);
              s.data = e;
          ...
          class RenderTask {
            ...
            get promise() {
              return this.#d.capability.promise;
            }
            cancel(t = 0) {
              this.#d.cancel(null, t);
            }
            get separateAnnots() {
              const { separateAnnots: t } = this.#d.operatorList;
              if (!t) return !1;
              const { annotationCanvasMap: e } = this.#d;
          ...
          class InternalRenderTask {
            ...
            cancel(t = null, e = 0) {
              ...
              this.cancelled = !0;
              this.gfx?.endDrawing();
              this._canvas && InternalRenderTask.#u.delete(this._canvas);
              this.callback(
                t ||
        ...
        (t, e, s) => {
          ...
          class AnnotationStorage {
            ...
            remove(t) {
              ...
              if ('function' == typeof this.onAnnotationEditor) {
                for (const t of this.#g.values())
                  if (t instanceof i.AnnotationEditor) return;
                this.onAnnotationEditor(null);
              }
            }
            setValue(t, e) {
              ...
              n && this.#m();
              e instanceof i.AnnotationEditor &&
            ...
            getAll() {
              return this.#g.size > 0 ? (0, n.objectFromMap)(this.#g) : null;
            }
            get size() {
              return this.#g.size;
            }
            ...
            get serializable() {
              ...
              for (const [e, s] of this.#g) {
                const n = s instanceof i.AnnotationEditor ? s.serialize() : s;
                n && t.set(e, n);
              }
              return t;
            }
            static getHash(t) {
              ...
              for (const [s, n] of t) e.update(`${s}:${JSON.stringify(n)}`);
              return e.hexdigest();
            }
          }
          ...
          class PrintAnnotationStorage extends AnnotationStorage {
            ...
            constructor(t) {
              super();
              this.#f = structuredClone(t.serializable);
            }
            get print() {
              (0, n.unreachable)(
        ...
        (t, e, s) => {
          ...
          class AnnotationEditor {
            #b = this.focusin.bind(this);
            #A = this.focusout.bind(this);
            #_ = !1;
            #y = !1;
            #v = !1;
            _uiManager = null;
            ...
            constructor(t) {
              this.constructor === AnnotationEditor &&
                (0, i.unreachable)('Cannot initialize AnnotationEditor.');
            ...
            focusin(t) {
              this.#_ ? (this.#_ = !1) : this.parent.setSelected(this);
            }
            focusout(t) {
            ...
            render() {
              ...
              this.div.addEventListener('focusin', this.#b);
              this.div.addEventListener('focusout', this.#A);
            ...
            static deserialize(t, e, s) {
              ...
              const [i, a] = n.pageDimensions,
                [r, o, l, c] = n.getRectInCurrentCoords(t.rect, a);
              n.x = r / i;
              n.y = o / a;
              n.width = l / i;
              n.height = c / a;
            ...
            remove() {
              this.div.removeEventListener('focusin', this.#b);
              this.div.removeEventListener('focusout', this.#A);
        ...
        (t, e, s) => {
          ...
          e.bindEvents = function bindEvents(t, e, s) {
            for (const n of s) e.addEventListener(n, t[n].bind(t));
          };
          ...
          class IdManager {
            #x = 0;
            getId() {
              return `${n.AnnotationEditorPrefix}${this.#x++}`;
            }
          }
          class CommandManager {
            ...
            add({
              ...
              mustExec: s,
              type: n = NaN,
              overwriteIfSameType: i = !1,
              keepUndo: a = !1,
            }) {
              s && t();
              if (this.#C) return;
              const r = { cmd: t, undo: e, type: n };
              if (-1 === this.#T) {
              ...
              if (i && this.#E[this.#T].type === n) {
                a && (r.undo = this.#E[this.#T].undo);
                this.#E[this.#T] = r;
                return;
              }
              const o = this.#T + 1;
              if (o === this.#P) this.#E.splice(0, 1);
              else {
                this.#T = o;
                o < this.#E.length && this.#E.splice(o);
              }
              this.#E.push(r);
            }
            undo() {
            ...
            constructor(t) {
              ...
              for (const [s, n] of t)
                for (const t of s) {
                  ...
                  if (e && s) {
                    this.callbacks.set(t.slice(4), n);
          ...
          class AnnotationEditorUIManager {
            ...
            #j = new IdManager();
            #U = !1;
            #B = n.AnnotationEditorType.NONE;
            #q = new Set();
            #W = this.copy.bind(this);
            #H = this.cut.bind(this);
            #G = this.paste.bind(this);
            #z = this.keydown.bind(this);
            #V = this.onEditingAction.bind(this);
            #X = this.onPageChanging.bind(this);
            #$ = this.onScaleChanging.bind(this);
            #Y = this.onRotationChanging.bind(this);
            #K = {
              isEditing: !1,
              isEmpty: !0,
            ...
            constructor(t, e, s) {
              this.#J = t;
              this.#N = e;
              this.#N._on('editingaction', this.#V);
              this.#N._on('pagechanging', this.#X);
              this.#N._on('scalechanging', this.#$);
              this.#N._on('rotationchanging', this.#Y);
              this.#M = s;
              this.viewParameters = {
            ...
            destroy() {
              this.#Q();
              this.#N._off('editingaction', this.#V);
              this.#N._off('pagechanging', this.#X);
              this.#N._off('scalechanging', this.#$);
              this.#N._off('rotationchanging', this.#Y);
            ...
            onScaleChanging({ scale: t }) {
              ...
              this.viewParameters.realScale =
                t * i.PixelsPerInch.PDF_TO_CSS_UNITS;
            ...
            addToAnnotationStorage(t) {
              t.isEmpty() ||
                !this.#M ||
                this.#M.has(t.id) ||
                this.#M.setValue(t.id, t);
            }
            #Z() {
              this.#J.addEventListener('keydown', this.#z);
            }
            #Q() {
              this.#J.removeEventListener('keydown', this.#z);
            }
            #tt() {
              document.addEventListener('copy', this.#W);
              document.addEventListener('cut', this.#H);
              document.addEventListener('paste', this.#G);
            }
            #et() {
              document.removeEventListener('copy', this.#W);
              document.removeEventListener('cut', this.#H);
              document.removeEventListener('paste', this.#G);
            }
            copy(t) {
              t.preventDefault();
              this.#k && this.#k.commitOrRemove();
              if (!this.hasSelection) return;
              const e = [];
              for (const t of this.#q) t.isEmpty() || e.push(t.serialize());
              0 !== e.length &&
            ...
            paste(t) {
              ...
              this.unselectAll();
              const s = this.#R.get(this.#I);
              try {
                const t = [];
                for (const n of e) {
                  const e = s.deserialize(n);
                  if (!e) return;
                  t.push(e);
                }
                const cmd = () => {
            ...
            #it(t) {
              Object.entries(t).some(([t, e]) => this.#K[t] !== e) &&
            ...
            setEditingState(t) {
              if (t) {
                ...
                this.#tt();
                this.#it({
                  isEditing: this.#B !== n.AnnotationEditorType.NONE,
                  isEmpty: this.#rt(),
            ...
            registerEditorTypes(t) {
              if (!this.#O) {
                this.#O = t;
                for (const t of this.#O) this.#at(t.defaultPropertiesToUpdate);
              }
            }
            getId() {
              return this.#j.getId();
            ...
            addLayer(t) {
              this.#R.set(t.pageIndex, t);
              this.#U ? t.enable() : t.disable();
            }
            removeLayer(t) {
            ...
            updateParams(t, e) {
              if (this.#O) {
                for (const s of this.#q) s.updateParams(t, e);
                for (const s of this.#O) s.updateDefaultParams(t, e);
              }
            }
            #lt() {
              if (!this.#U) {
                this.#U = !0;
                for (const t of this.#R.values()) t.enable();
              }
            }
            #ot() {
              this.unselectAll();
            ...
            getEditors(t) {
              const e = [];
              for (const s of this.#F.values()) s.pageIndex === t && e.push(s);
              return e;
            }
            getEditor(t) {
              return this.#F.get(t);
            ...
            setActiveEditor(t) {
              if (this.#k !== t) {
                this.#k = t;
                t && this.#at(t.propertiesToUpdate);
              }
            }
            toggleSelected(t) {
              if (this.#q.has(t)) {
                ...
                this.#q.add(t);
                t.select();
                this.#at(t.propertiesToUpdate);
                this.#it({ hasSelectedEditor: !0 });
              }
            }
            setSelected(t) {
              for (const e of this.#q) e !== t && e.unselect();
              this.#q.clear();
              this.#q.add(t);
              t.select();
              this.#at(t.propertiesToUpdate);
            ...
            #rt() {
              if (0 === this.#F.size) return !0;
              if (1 === this.#F.size)
                for (const t of this.#F.values()) return t.isEmpty();
              return !1;
            }
            delete() {
              this.commitOrRemove();
            ...
            selectAll() {
              for (const t of this.#q) t.commit();
              this.#nt(this.#F.values());
            }
            unselectAll() {
              if (this.#k) this.#k.commitOrRemove();
              else if (0 !== this.#q.size) {
                for (const t of this.#q) t.unselect();
                this.#q.clear();
        ...
        (t, e, s) => {
          ...
          e.getCurrentTransform = function getCurrentTransform(t) {
            const { a: e, b: s, c: n, d: i, e: a, f: r } = t.getTransform();
            return [e, s, n, i, a, r];
          };
          ...
          e.getXfaPageViewport = function getXfaPageViewport(
            ...
            const { width: n, height: i } = t.attributes.style,
          ...
          e.setLayerDimensions = function setLayerDimensions(
            ...
            if (e instanceof PageViewport) {
              const { pageWidth: n, pageHeight: i } = e.rawDims,
                { style: a } = t,
                r = `calc(var(--scale-factor) * ${n}px)`,
                o = `calc(var(--scale-factor) * ${i}px)`;
          ...
          async function fetchData(t, e = !1) {
            if (isValidFetchUrl(t, document.baseURI)) {
              ...
              return e
                ...
                : (0, i.stringToBytes)(await s.text());
            }
            return new Promise((s, n) => {
                ...
                if (a.readyState === XMLHttpRequest.DONE) {
                  if (200 === a.status || 0 === a.status) {
                    ...
                    e && a.response
                      ...
                      : !e &&
                        a.responseText &&
                        (t = (0, i.stringToBytes)(a.responseText));
                    if (t) {
                      s(t);
                      return;
                    }
          ...
          class PageViewport {
            ...
            convertToViewportRectangle(t) {
              const e = i.Util.applyTransform([t[0], t[1]], this.transform),
          ...
          class RenderingCancelledException extends i.BaseException {
            constructor(t, e, s = 0) {
          ...
          e.StatTimer = class StatTimer {
            ...
            time(t) {
              t in this.started &&
                (0, i.warn)(`Timer is already running for ${t}`);
              this.started[t] = Date.now();
            }
            timeEnd(t) {
              t in this.started ||
                (0, i.warn)(`Timer has not been started for ${t}`);
              this.times.push({
                name: t,
            ...
            toString() {
              ...
              for (const { name: s, start: n, end: i } of this.times)
                t.push(`${s.padEnd(e)} ${i - n}ms\n`);
              return t.join('');
            }
          };
          ...
          function getRGB(t) {
            ...
            if (t.startsWith('rgba('))
              return t
                ...
                .map((t) => parseInt(t))
                .slice(0, 3);
            (0, i.warn)(`Not a valid color format: "${t}"`);
            return [0, 0, 0];
          }
        },
        (t, e, s) => {
              ...
              if (this.isFontLoadingAPISupported) {
                ...
                if (e) {
                  ...
                  try {
                    ...
                    (0, n.warn)(`Failed to load font '${e.family}': '${s}'.`);
                    t.disableFontFace = !0;
                    throw s;
                  }
                }
        ...
        (t, e, s) => {
          ...
          function drawImageAtIntegerCoords(t, e, s, n, a, r, o, l, c, h) {
            const [d, u, p, g, m, f] = (0, i.getCurrentTransform)(t);
            if (0 === u && 0 === p) {
              const i = o * d + m,
                b = Math.round(i),
                A = l * g + f,
          ...
          class CanvasExtraState {
            ...
            updatePathMinMax(t, e, s) {
              [e, s] = n.Util.applyTransform([e, s], t);
            ...
            updateRectMinMax(t, e) {
              const s = n.Util.applyTransform(e, t),
            ...
            updateCurvePathMinMax(t, e, s, i, a, r, o, l, c, h) {
              const d = n.Util.bezierBoundingBox(e, s, i, a, r, o, l, c);
              if (h) {
          ...
          function putBinaryImageData(t, e, s = null) {
            ...
            if (e.kind === n.ImageKind.GRAYSCALE_1BPP) {
              const e = p.byteLength,
                ...
                A = (a + 7) >> 3;
              let _ = 4294967295,
                y = n.FeatureTest.isLittleEndian ? 4278190080 : 255;
              S && 255 === S[0] && 0 === S[255] && ([_, y] = [y, _]);
              for (m = 0; m < l; m++) {
                b = m < o ? h : r;
                d = 0;
                for (f = 0; f < b; f++) {
              ...
              if (e.kind !== n.ImageKind.RGB_24BPP)
          ...
          function copyCtxState(t, e) {
            ...
            for (const n of s) void 0 !== t[n] && (e[n] = t[n]);
          ...
          function composeSMaskAlpha(t, e, s) {
            ...
            for (let i = 3; i < n; i += 4) {
              const n = s ? s[t[i]] : t[i];
              e[i] = (e[i] * n * 0.00392156862745098) | 0;
            }
          }
          function composeSMaskLuminosity(t, e, s) {
            const n = t.length;
            for (let i = 3; i < n; i += 4) {
              const n = 77 * t[i - 3] + 152 * t[i - 2] + 28 * t[i - 1];
              e[i] = s ? (e[i] * s[n >> 8]) >> 8 : (e[i] * n) >> 16;
            }
          }
              ...
              !(function genericComposeSMask(t, e, s, n, i, a, r, o, l, c, h) {
                ...
                m =
                  'Luminosity' === i
                    ...
                    : composeSMaskAlpha;
                const f = Math.min(n, Math.ceil(1048576 / s));
                for (let i = 0; i < n; i += f) {
                  const a = Math.min(f, n - i),
                    b = t.getImageData(o - c, i + (l - h), s, a),
                    A = e.getImageData(o, i + l, s, a);
                  d && composeSMaskBackdrop(b.data, u, p, g);
                  m(b.data, A.data, r);
                  e.putImageData(A, o, i + l);
                }
              })(
                e.context,
                s,
          ...
          function getImageSmoothingEnabled(t, e) {
            const s = n.Util.singularValueDecompose2dScale(t);
            s[0] = Math.fround(s[0]);
            s[1] = Math.fround(s[1]);
            const a = Math.fround(
              (globalThis.devicePixelRatio || 1) *
                i.PixelsPerInch.PDF_TO_CSS_UNITS,
            );
          ...
          class CanvasGraphics {
            constructor(
              ...
              s,
              n,
              { optionalContentConfig: i, markedContentStack: a = null },
              r,
              o,
            ) {
              this.ctx = t;
            ...
            beginDrawing({
              ...
              if (this.foregroundColor && this.backgroundColor) {
                ...
                n = this.ctx.fillStyle;
                s = 'string' == typeof n && /^#[0-9A-Fa-f]{6}$/.test(n);
                if (('#000000' === t && '#ffffff' === e) || t === e || !s)
                  this.foregroundColor = this.backgroundColor = null;
                else {
                  const [s, a, r] = (0, i.getRGB)(n),
                    newComp = (t) =>
                      (t /= 255) <= 0.03928
                        ? t / 12.92
                        : ((t + 0.055) / 1.055) ** 2.4,
              ...
              if (s) {
                ...
                this.ctx.save();
                this.ctx.transform(
                  ...(0, i.getCurrentTransform)(this.compositeCtx),
                );
              }
              this.ctx.save();
            ...
            executeOperatorList(t, e, s, i) {
              ...
              for (;;) {
                ...
                g = r[o];
                if (g !== n.OPS.dependency) this[g].apply(this, a[o]);
                else
                  for (const t of a[o]) {
            ...
            _scaleImage(t, e) {
              ...
              for (; (r > 2 && l > 1) || (o > 2 && c > 1); ) {
                ...
                i = this.cachedCanvases.getCanvas(h, e, s);
                a = i.context;
                a.clearRect(0, 0, e, s);
            ...
            _createMaskCanvas(t) {
              ...
              let g = n.Util.transform(c, [1 / s, 0, 0, -1 / r, 0, 0]);
              g = n.Util.transform(g, [1, 0, 0, 1, 0, -r]);
              const m = n.Util.applyTransform([0, 0], g),
              ...
              if (!u) {
                u = this._scaleImage(
                  p.canvas,
                  (0, i.getCurrentTransformInverse)(v),
                );
                u = u.img;
                h && l && h.set(d, u);
              }
              ...
              const E = n.Util.transform((0, i.getCurrentTransformInverse)(v), [
                1,
                0,
                0,
                1,
            ...
            beginSMaskMode() {
              ...
              this.ctx = n.context;
              const a = this.ctx;
              a.setTransform(...(0, i.getCurrentTransform)(this.suspendedCtx));
            ...
            constructPath(t, e, s) {
              ...
              let o,
                ...
                c = r.x,
                h = r.y;
              const d = (0, i.getCurrentTransform)(a),
                u = (0 === d[0] && 0 === d[3]) || (0 === d[1] && 0 === d[2]),
                p = u ? s.slice(0) : null;
              for (let s = 0, i = 0, g = t.length; s < g; s++)
                switch (0 | t[s]) {
                  case n.OPS.rectangle:
                    ...
                    const t = e[i++],
                      ...
                      m = h + s;
                    a.moveTo(c, h);
                    if (0 === t || 0 === s) a.lineTo(g, m);
                    else {
                      a.lineTo(g, h);
                      a.lineTo(g, m);
                      a.lineTo(c, m);
                    }
                    u || r.updateRectMinMax(d, [c, h, g, m]);
                    a.closePath();
                    break;
                  case n.OPS.moveTo:
                    c = e[i++];
                  ...
                  case n.OPS.curveTo:
                    ...
                    c = e[i + 4];
                    h = e[i + 5];
                    a.bezierCurveTo(e[i], e[i + 1], e[i + 2], e[i + 3], c, h);
                  ...
                  case n.OPS.curveTo2:
                    o = c;
                    l = h;
                    a.bezierCurveTo(c, h, e[i], e[i + 1], e[i + 2], e[i + 3]);
                    r.updateCurvePathMinMax(
                      d,
                      o,
                      l,
                  ...
                  case n.OPS.curveTo3:
                    ...
                    c = e[i + 2];
                    h = e[i + 3];
                    a.bezierCurveTo(e[i], e[i + 1], c, h, c, h);
                    r.updateCurvePathMinMax(
                      d,
                      o,
                      l,
              ...
              if (this.contentVisible)
                if ('object' == typeof s && s?.getPattern) {
                  ...
                  e.strokeStyle = s.getPattern(
                    e,
                    this,
                    (0, i.getCurrentTransformInverse)(e),
                    a.PathType.STROKE,
                  );
            ...
            showText(t) {
              ...
              const o = this.ctx,
                ...
                b = r * e.fontMatrix[0],
                A =
                  e.textRenderingMode === n.TextRenderingMode.FILL &&
                  !s.disableFontFace &&
                  !e.patternFill;
              o.save();
              ...
              if (e.patternFill) {
                ...
                const t = e.fillColor.getPattern(
                  o,
                  this,
                  (0, i.getCurrentTransformInverse)(o),
                  a.PathType.FILL,
                );
              ...
              if (0 === v || 0 === y) {
                ...
                (t !== n.TextRenderingMode.STROKE &&
                  t !== n.TextRenderingMode.FILL_STROKE) ||
              ...
              if (
                ...
                for (p = 0; p < u; ++p) {
                  ...
                  const r = (g.isSpace ? c : 0) + l,
                    u = i.charProcOperatorList[g.operatorListId];
                  if (!u) {
                    (0, n.warn)(
                  ...
                  m = n.Util.applyTransform([g.width, 0], d)[0] * a + r;
                  e.translate(m, 0);
                  s.x += m * h;
                }
                e.restore();
            ...
            setCharWidth(t, e) {}
            setCharWidthAndBounds(t, e, s, n, i, a) {
            ...
            getColorN_Pattern(t) {
              ...
              if ('TilingPattern' === t[0]) {
                ...
                e = new a.TilingPattern(t, s, this.ctx, r, n);
            ...
            setStrokeRGBColor(t, e, s) {
              const i =
                this.selectColor?.(t, e, s) || n.Util.makeHexColor(t, e, s);
            ...
            shadingFill(t) {
              ...
              const r = (0, i.getCurrentTransformInverse)(e);
              if (r) {
                const t = e.canvas,
                  s = t.width,
                  i = t.height,
                  a = n.Util.applyTransform([0, 0], r),
                  o = n.Util.applyTransform([0, i], r),
                  l = n.Util.applyTransform([s, 0], r),
                  c = n.Util.applyTransform([s, i], r),
              ...
              if (this.contentVisible) {
                ...
                if (e) {
                  ...
                  this.current.updateRectMinMax(
                    (0, i.getCurrentTransform)(this.ctx),
                    e,
                  );
                  this.clip();
                  this.endPath();
            ...
            endGroup(t) {
              ...
              if (t.smask) {
                ...
                this.ctx.restore();
                const t = (0, i.getCurrentTransform)(this.ctx);
                this.restore();
                this.ctx.save();
                this.ctx.setTransform(...t);
                const s = n.Util.getAxialAlignedBoundingBox(
            ...
            beginAnnotation(t, e, s, a, r) {
              ...
              if (Array.isArray(e) && 4 === e.length) {
                ...
                if (r && this.annotationCanvasMap) {
                  ...
                  e[2] = a;
                  e[3] = o;
                  const [r, l] = n.Util.singularValueDecompose2dScale(
                      (0, i.getCurrentTransform)(this.ctx),
                    ),
            ...
            paintImageMaskXObject(t) {
              ...
              if (n) {
                void 0 === n.compiled &&
                  (n.compiled = (function compileType3Glyph(t) {
                    ...
                    if (p > 1e3) return null;
                    const g = new Int32Array([0, i, -1, 0, -i, 0, 0, 0, 1]),
                      m = new Path2D();
                    for (a = 0; p && a <= s; a++) {
                      let t = a * i;
                      const s = t + e;
              ...
              const i = this._createMaskCanvas(t),
                a = i.canvas;
              s.save();
            ...
            paintImageMaskXObjectRepeat(t, e, s = 0, a = 0, r, o) {
              ...
              const l = this.ctx;
              l.save();
              const c = (0, i.getCurrentTransform)(l);
              ...
              for (let t = 0, i = o.length; t < i; t += 2) {
                const i = n.Util.transform(c, [e, s, a, r, o[t], o[t + 1]]),
                  [d, u] = n.Util.applyTransform([0, 0], i);
            ...
            paintInlineImageXObject(t) {
              ...
              if (
                ...
                const n = this.cachedCanvases.getCanvas('inlineImage', e, s);
                putBinaryImageData(n.context, t, this.current.transferMaps);
                a = n.canvas;
              }
              const r = this._scaleImage(
                a,
                (0, i.getCurrentTransformInverse)(n),
              );
              n.imageSmoothingEnabled = getImageSmoothingEnabled(
                (0, i.getCurrentTransform)(n),
                t.interpolate,
              );
              drawImageAtIntegerCoords(
                n,
            ...
            getScaleForStroking() {
              if (!this._cachedScaleForStroking) {
                const { lineWidth: t } = this.current,
                  e = (0, i.getCurrentTransform)(this.ctx);
                let s, n;
                if (0 === e[1] && 0 === e[2]) {
                  const i = Math.abs(e[0]),
                    a = Math.abs(e[3]);
                  if (0 === t) {
                    s = 1 / i;
                    n = 1 / a;
                  ...
                  const i = Math.abs(e[0] * e[3] - e[2] * e[1]),
                ...
                this._cachedScaleForStroking = [s, n];
              }
          ...
          for (const t in n.OPS)
            void 0 !== CanvasGraphics.prototype[t] &&
              (CanvasGraphics.prototype[n.OPS[t]] =
        ...
        (t, e, s) => {
            ...
            getPattern(t, e, s, a) {
              ...
              if (a === r.STROKE || a === r.FILL) {
                const r = e.current.getClippedPathBoundingBox(
                    a,
                    (0, i.getCurrentTransform)(t),
                  ) || [0, 0, 0, 0],
                  l = Math.ceil(r[2] - r[0]) || 1,
                  c = Math.ceil(r[3] - r[1]) || 1,
                ...
                d.translate(-r[0], -r[1]);
                s = n.Util.transform(s, [1, 0, 0, 1, r[0], r[1]]);
          ...
          class MeshShadingPattern extends BaseShadingPattern {
            ...
            _createMeshCanvas(t, e, s) {
              ...
              if (e) {
                const t = f.data;
                for (let s = 0, n = t.length; s < n; s += 4) {
                  t[s] = e[0];
                  t[s + 1] = e[1];
                  t[s + 2] = e[2];
                  t[s + 3] = 255;
            ...
            getPattern(t, e, s, a) {
              ...
              let o;
              if (a === r.SHADING)
                o = n.Util.singularValueDecompose2dScale(
                  (0, i.getCurrentTransform)(t),
                );
              else {
          ...
          class TilingPattern {
            ...
            getSizeAndScale(t, e, s) {
              ...
              let i = Math.ceil(t * s);
              i >= n ? (i = n) : (s = i / t);
              return { scale: s, size: i };
            }
            clipBbox(t, e, s, n, a) {
              const r = n - e,
                o = a - s;
              t.ctx.rect(e, s, r, o);
              t.current.updateRectMinMax((0, i.getCurrentTransform)(t.ctx), [
                e,
                s,
                n,
                a,
            ...
            setFillAndStrokeStyleToContext(t, e, s) {
              ...
              switch (e) {
                case o:
                  ...
                  break;
                case l:
                  const r = n.Util.makeHexColor(s[0], s[1], s[2]);
                  i.fillStyle = r;
                  i.strokeStyle = r;
                  a.fillColor = r;
                  a.strokeColor = r;
        ...
        (t, e, s) => {
          ...
          e.applyMaskImageData = function applyMaskImageData({
            ...
            for (let n = 0; n < r; n++) {
              ...
              if (0 === u) continue;
              const n = e < p ? t[e++] : 255;
              for (let t = 0; t < u; t++) s[i++] = n & (1 << (7 - t)) ? h : c;
            }
            return { srcPos: e, destPos: i };
          };
          var n = s(1);
        },
        (t, e) => {
            ...
            constructor(t, e, s) {
              ...
              this._onComObjOnMessage = (t) => {
                ...
                if (e.callback) {
                  ...
                  if (e.callback === i) s.resolve(e.data);
                  else {
                    if (e.callback !== a)
                ...
                } else e.streamId ? this._createStreamSink(e) : n(e.data);
              };
        ...
        (t, e, s) => {
          ...
          e.Metadata = class Metadata {
            ...
            getAll() {
              return (0, n.objectFromMap)(this.#ht);
            }
            has(t) {
        ...
        (t, e, s) => {
          ...
          class OptionalContentGroup {
            ...
            _setVisible(t, e) {
              t !== a &&
                (0, n.unreachable)('Internal method `_setVisible` called.');
              this.#ut = e;
            }
          }
          e.OptionalContentConfig = class OptionalContentConfig {
            ...
            constructor(t) {
              ...
              if (null !== t) {
                ...
                if ('OFF' === t.baseState)
                  for (const t of this.#gt.values()) t._setVisible(a, !1);
                for (const e of t.on) this.#gt.get(e)._setVisible(a, !0);
                for (const e of t.off) this.#gt.get(e)._setVisible(a, !1);
                this.#mt = this.getHash();
              }
            }
            #bt(t) {
              const e = t.length;
              ...
              for (let i = 1; i < e; i++) {
                const e = t[i];
                let a;
                if (Array.isArray(e)) a = this.#bt(e);
                else {
                  if (!this.#gt.has(e)) {
                    (0, n.warn)(`Optional content group not found: ${e}`);
                    return !0;
                  }
                  a = this.#gt.get(e).visible;
                }
                switch (s) {
                  case 'And':
                    if (!a) return !1;
            ...
            isVisible(t) {
              ...
              if ('OCG' === t.type) {
                ...
                return this.#gt.get(t.id).visible;
              }
              if ('OCMD' === t.type) {
                if (t.expression) return this.#bt(t.expression);
                if (!t.policy || 'AnyOn' === t.policy) {
                  for (const e of t.ids) {
                    ...
                    if (this.#gt.get(e).visible) return !0;
                  }
                  return !1;
                }
                if ('AllOn' === t.policy) {
                  for (const e of t.ids) {
                    ...
                    if (!this.#gt.get(e).visible) return !1;
                  }
                  return !0;
                }
                if ('AnyOff' === t.policy) {
            ...
            setVisibility(t, e = !0) {
              if (this.#gt.has(t)) {
                this.#gt.get(t)._setVisible(a, !!e);
                this.#pt = null;
              } else (0, n.warn)(`Optional content group not found: ${t}`);
            }
            get hasInitialVisibility() {
              return this.getHash() === this.#mt;
            }
            getOrder() {
              return this.#gt.size
                ? this.#ft
            ...
            getGroups() {
              return this.#gt.size > 0 ? (0, n.objectFromMap)(this.#gt) : null;
            }
            getGroup(t) {
              return this.#gt.get(t) || null;
            }
            getHash() {
              if (null !== this.#pt) return this.#pt;
              const t = new i.MurmurHash3_64();
              for (const [e, s] of this.#gt) t.update(`${e}:${s.visible}`);
              return (this.#pt = t.hexdigest());
            }
          };
        },
        (t, e, s) => {
        ...
        (t, e, s) => {
          ...
          e.updateTextLayer = function updateTextLayer({
            ...
            r && (0, i.setLayerDimensions)(t, { rotation: e.rotation });
            if (o) {
              const t = getCtx(0, a),
                i = {
                  prevFontSize: null,
          ...
          function getCtx(t, e) {
            let s;
            if (e && n.FeatureTest.isOffscreenCanvasSupported)
          ...
          function appendText(t, e, s) {
            ...
            t._textDivs.push(i);
            const l = n.Util.transform(t._transform, e.transform);
            let c = Math.atan2(l[1], l[0]);
            const h = s[e.fontName];
            h.vertical && (c += Math.PI / 2);
            const d = Math.hypot(l[2], l[3]),
              u =
                d *
                (function getAscent(t, e) {
                  ...
                  const n = getCtx(a, e);
                  n.font = `30px ${t}`;
                  const i = n.measureText('');
                  let o = i.fontBoundingBoxAscent,
                  ...
                  n.clearRect(0, 0, a, a);
                  n.strokeText('g', 0, 0);
                  let c = n.getImageData(0, 0, a, a).data;
                  l = 0;
            ...
            if (t._container === t._rootContainer) {
              f.left = `${((100 * p) / t._pageWidth).toFixed(2)}%`;
              f.top = `${((100 * g) / t._pageHeight).toFixed(2)}%`;
            } else {
              f.left = `${m}${p.toFixed(2)}px)`;
              f.top = `${m}${g.toFixed(2)}px)`;
            }
            f.fontSize = `${m}${d.toFixed(2)}px)`;
            ...
            if (e.str.length > 1) b = !0;
              ...
              t !== s && Math.max(t, s) / Math.min(t, s) > 1.5 && (b = !0);
            }
          ...
          class TextLayerRenderTask {
            ...
            cancel() {
              ...
              if (this._reader) {
                this._reader
                  .cancel(new n.AbortException('TextLayer task cancelled.'))
                  .catch(() => {});
                this._reader = null;
              }
            ...
            _render() {
              ...
              if (this._isReadableStream) {
                const pump = () => {
                  this._reader.read().then(({ value: s, done: n }) => {
                    if (n) t.resolve();
                    else {
        ...
        (t, e, s) => {
          ...
          class AnnotationEditorLayer {
            #At;
            #_t = !1;
            #yt = this.pointerup.bind(this);
            #vt = this.pointerdown.bind(this);
            #St = new Map();
            #xt = !1;
            #Et = !1;
            #Ct;
            ...
            constructor(t) {
              ...
              this.pageIndex = t.pageIndex;
              this.div = t.div;
              this.#At = t.accessibilityManager;
              this.#Ct.addLayer(this);
            }
            updateToolbar(t) {
              this.#Ct.updateToolbar(t);
            }
            updateMode(t = this.#Ct.getMode()) {
              this.#Pt();
            ...
            addInkEditorIfNeeded(t) {
              if (!t && this.#Ct.getMode() !== n.AnnotationEditorType.INK)
                return;
              if (!t)
                for (const t of this.#St.values())
                  if (t.isEmpty()) {
                    t.setInBackground();
                    return;
                  }
              this.#Tt({ offsetX: 0, offsetY: 0 }).setInBackground();
            }
            setEditingState(t) {
              this.#Ct.setEditingState(t);
            }
            addCommands(t) {
              this.#Ct.addCommands(t);
            }
            enable() {
              this.div.style.pointerEvents = 'auto';
              for (const t of this.#St.values()) t.enableEditing();
            }
            disable() {
              this.div.style.pointerEvents = 'none';
              for (const t of this.#St.values()) t.disableEditing();
            }
            setActiveEditor(t) {
              this.#Ct.getActive() !== t && this.#Ct.setActiveEditor(t);
            }
            enableClick() {
              this.div.addEventListener('pointerdown', this.#vt);
              this.div.addEventListener('pointerup', this.#yt);
            }
            disableClick() {
              this.div.removeEventListener('pointerdown', this.#vt);
              this.div.removeEventListener('pointerup', this.#yt);
            }
            attach(t) {
              this.#St.set(t.id, t);
            }
            detach(t) {
              this.#St.delete(t.id);
              this.#At?.removePointerInTextLayer(t.contentDiv);
            }
            remove(t) {
              this.#Ct.removeEditor(t);
              this.detach(t);
              ...
              setTimeout(() => {
                ...
                document.activeElement === document.body &&
                  this.#Ct.focusMainContainer();
              }, 0);
              this.#Et || this.addInkEditorIfNeeded(!1);
            }
            #wt(t) {
              if (t.parent !== this) {
                this.attach(t);
            ...
            add(t) {
              ...
              t.onceAdded();
              this.#Ct.addToAnnotationStorage(t);
            }
            moveEditorInDOM(t) {
              this.#At?.moveElementInDOM(this.div, t.div, t.contentDiv, !0);
            }
            addOrRebuild(t) {
            ...
            getNextId() {
              return this.#Ct.getId();
            }
            #kt(t) {
              switch (this.#Ct.getMode()) {
            ...
            deserialize(t) {
              switch (t.annotationType) {
                case n.AnnotationEditorType.FREETEXT:
                  return a.FreeTextEditor.deserialize(t, this, this.#Ct);
                case n.AnnotationEditorType.INK:
                  return r.InkEditor.deserialize(t, this, this.#Ct);
              }
              return null;
            }
            #Tt(t) {
            ...
            setSelected(t) {
              this.#Ct.setSelected(t);
            }
            toggleSelected(t) {
              this.#Ct.toggleSelected(t);
            }
            isSelected(t) {
              return this.#Ct.isSelected(t);
            }
            unselect(t) {
              this.#Ct.unselect(t);
            }
            ...
            pointerdown(t) {
              ...
              this.#xt = !0;
              const s = this.#Ct.getActive();
              this.#_t = !s || s.isEmpty();
            }
            drop(t) {
              const e = t.dataTransfer.getData('text/plain'),
                s = this.#Ct.getEditor(e);
              if (!s) return;
              t.preventDefault();
            ...
            destroy() {
              this.#Ct.getActive()?.parent === this &&
                this.#Ct.setActiveEditor(null);
              for (const t of this.#St.values()) {
                this.#At?.removePointerInTextLayer(t.contentDiv);
                t.setParent(null);
                t.isAttachedToDOM = !1;
              ...
              this.div = null;
              this.#St.clear();
              this.#Ct.removeLayer(this);
            }
            #Pt() {
              this.#Et = !0;
              for (const t of this.#St.values()) t.isEmpty() && t.remove();
              this.#Et = !1;
            }
            render({ viewport: t }) {
              this.viewport = t;
              ...
              for (const t of this.#Ct.getEditors(this.pageIndex)) this.add(t);
              this.updateMode();
            }
            update({ viewport: t }) {
              this.#Ct.commitOrRemove();
              this.viewport = t;
        ...
        (t, e, s) => {
          ...
          class FreeTextEditor extends a.AnnotationEditor {
            #Ft = this.editorDivBlur.bind(this);
            #Rt = this.editorDivFocus.bind(this);
            #Mt = this.editorDivInput.bind(this);
            #Dt = this.editorDivKeydown.bind(this);
            #It;
            #Ot = '';
            #Lt = `${this.id}-editor`;
            #Nt = !1;
            ...
            static _keyboardManager = new i.KeyboardManager([
              [
            ...
            constructor(t) {
              ...
              this.#jt = t.fontSize || FreeTextEditor._defaultFontSize;
            }
            static initialize(t) {
            ...
            static get defaultPropertiesToUpdate() {
              return [
                [
                  n.AnnotationEditorParamsType.FREETEXT_SIZE,
            ...
            get propertiesToUpdate() {
              return [
                [n.AnnotationEditorParamsType.FREETEXT_SIZE, this.#jt],
                [n.AnnotationEditorParamsType.FREETEXT_COLOR, this.#It],
              ];
            }
            #Ut(t) {
              const setFontsize = (t) => {
                  this.editorDiv.style.fontSize = `calc(${t}px * var(--scale-factor))`;
                  this.translate(0, -(t - this.#jt) * this.parentScale);
                  this.#jt = t;
                  this.#qt();
                },
                e = this.#jt;
            ...
            #Bt(t) {
              ...
              this.addCommands({
                cmd: () => {
                  this.#It = this.editorDiv.style.color = t;
                },
                undo: () => {
                  this.#It = this.editorDiv.style.color = e;
                },
                mustExec: !0,
            ...
            getInitialTranslation() {
              ...
              return [
                ...
                -(FreeTextEditor._internalPadding + this.#jt) * t,
              ];
            }
            rebuild() {
              super.rebuild();
            ...
            enableEditMode() {
              if (!this.isInEditMode()) {
                ...
                this.editorDiv.addEventListener('keydown', this.#Dt);
                this.editorDiv.addEventListener('focus', this.#Rt);
                this.editorDiv.addEventListener('blur', this.#Ft);
                this.editorDiv.addEventListener('input', this.#Mt);
              }
            }
            disableEditMode() {
              if (this.isInEditMode()) {
                ...
                this.div.setAttribute('aria-activedescendant', this.#Lt);
                this.div.draggable = !0;
                this.editorDiv.removeEventListener('keydown', this.#Dt);
                this.editorDiv.removeEventListener('focus', this.#Rt);
                this.editorDiv.removeEventListener('blur', this.#Ft);
                this.editorDiv.removeEventListener('input', this.#Mt);
            ...
            render() {
              ...
              this.editorDiv.setAttribute('id', this.#Lt);
              this.enableEditing();
              ...
              s.fontSize = `calc(${this.#jt}px * var(--scale-factor))`;
              s.color = this.#It;
            ...
            static deserialize(t, e, s) {
              ...
              i.#jt = t.fontSize;
              i.#It = n.Util.makeHexColor(...t.color);
              i.#Ot = t.value;
              return i;
            }
            serialize() {
        ...
        (t, e, s) => {
          ...
          var n = s(1),
            ...
            r = s(5);
          const o = 16;
          class InkEditor extends i.AnnotationEditor {
            #Ht = 0;
            #Gt = 0;
            #zt = 0;
            #Vt = this.canvasPointermove.bind(this);
            #Xt = this.canvasPointerleave.bind(this);
            #$t = this.canvasPointerup.bind(this);
            #Yt = this.canvasPointerdown.bind(this);
            #Kt = !1;
            #Jt = !1;
            #Qt = null;
            #Zt = null;
            ...
            enableEditMode() {
              if (!this.#Kt && null !== this.canvas) {
                super.enableEditMode();
                this.div.draggable = !1;
                this.canvas.addEventListener('pointerdown', this.#Yt);
                this.canvas.addEventListener('pointerup', this.#$t);
              }
            }
            disableEditMode() {
              if (this.isInEditMode() && null !== this.canvas) {
                ...
                this.canvas.removeEventListener('pointerdown', this.#Yt);
                this.canvas.removeEventListener('pointerup', this.#$t);
              }
            }
            onceAdded() {
              this.div.draggable = !this.isEmpty();
            ...
            #pe(t, e) {
              const [s, n] = this.currentPath.at(-1);
              if (t !== s || e !== n) {
                this.currentPath.push([t, e]);
                this.#Qt = [t, e];
              }
            ...
            #ge(t, e) {
              ...
              if (1 !== this.currentPath.length)
                i = (0, a.fitCurve)(this.currentPath, 30, null);
              else {
                const s = [t, e];
                i = [[s, s.slice(), s.slice(), s]];
              }
              const r = InkEditor.#me(i);
            ...
            canvasPointerdown(t) {
              if (0 === t.button && this.isInEditMode() && !this.#Kt) {
                this.setInForeground();
                'mouse' !== t.type && this.div.focus();
                t.stopPropagation();
                this.canvas.addEventListener('pointerleave', this.#Xt);
                this.canvas.addEventListener('pointermove', this.#Vt);
                this.#ue(t.offsetX, t.offsetY);
              }
            }
            canvasPointermove(t) {
              t.stopPropagation();
              this.#pe(t.offsetX, t.offsetY);
            }
            canvasPointerup(t) {
              if (
                0 === t.button &&
            ...
            #be(t) {
              this.#ge(t.offsetX, t.offsetY);
              this.canvas.removeEventListener('pointerleave', this.#Xt);
              this.canvas.removeEventListener('pointermove', this.#Vt);
              this.addToAnnotationStorage();
            }
            #oe() {
            ...
            render() {
              ...
              if (this.width) {
                ...
                this.#Jt = !0;
                this.#ce();
                this.setDims(this.width * s, this.height * n);
                this.#re();
                this.#Ae();
                this.div.classList.add('disabled');
              } else {
            ...
            setDimensions(t, e) {
              const s = Math.round(t),
                n = Math.round(e);
              if (this.#te === s && this.#ee === n) return;
              this.#te = s;
              this.#ee = n;
              this.canvas.style.visibility = 'hidden';
              if (this.#Ht && Math.abs(this.#Ht - t / e) > 0.01) {
                e = Math.ceil(t / this.#Ht);
                this.setDims(t, e);
              }
              const [i, a] = this.parentDimensions;
              this.width = t / i;
            ...
            static #me(t) {
              ...
              for (let s = 0, n = t.length; s < n; s++) {
                const [n, i, a, r] = t[s];
                0 === s && e.moveTo(...n);
                e.bezierCurveTo(i[0], i[1], a[0], a[1], r[0], r[1]);
              }
              return e;
            }
            #ve(t, e, s, n) {
              ...
              for (const l of this.paths) {
                ...
                for (let i = 0, c = l.length; i < c; i++) {
                  ...
                  r.push(m, f, b, A, _, y);
                  this.#Se(p, g, m, f, b, A, _, y, 4, o);
                }
                i.push({ bezier: r, points: o });
              }
              return i;
            }
            #Se(t, e, s, n, i, a, r, o, l, c) {
              if (this.#xe(t, e, s, n, i, a, r, o)) c.push(r, o);
              else {
                for (let h = 1; h < l - 1; h++) {
                  const d = h / l,
                    u = 1 - d;
            ...
            #ae(t = !1) {
              ...
              const e = this.#Ee(),
                s = this.#ye();
              this.#zt = Math.max(o, e[2] - e[0]);
              this.#Gt = Math.max(o, e[3] - e[1]);
              const n = Math.ceil(s + this.#zt * this.scaleFactor),
                i = Math.ceil(s + this.#Gt * this.scaleFactor),
            ...
            #Ae() {
              ...
              if (this.#Ht >= 1) {
                t.minHeight = '16px';
                t.minWidth = `${Math.round(this.#Ht * o)}px`;
              } else {
                t.minWidth = '16px';
                t.minHeight = `${Math.round(o / this.#Ht)}px`;
              }
            }
            static deserialize(t, e, s) {
              const i = super.deserialize(t, e, s);
              i.thickness = t.thickness;
              i.color = n.Util.makeHexColor(...t.color);
              i.opacity = t.opacity;
              const [a, r] = i.pageDimensions,
                l = i.width * a,
                c = i.height * r,
                h = i.parentScale,
                d = t.thickness / 2;
              ...
              const u = i.#Ee();
              i.#zt = Math.max(o, u[2] - u[0]);
              i.#Gt = Math.max(o, u[3] - u[1]);
              i.#_e(l, c);
              return i;
            }
            serialize() {
              ...
              const t = this.getRect(0, 0),
                ...
                s = i.AnnotationEditor._colorManager.convert(
        ...
        (t) => {
          function fitCubic(t, e, s, n, i) {
            ...
            [a, l, h] = generateAndReport(t, r, r, e, s, i);
            if (0 === l || l < n) return [a];
            if (l < n * n) {
              o = r;
              c = l;
              ...
              for (b = 0; b < 20; b++) {
                ...
                [a, l, h] = generateAndReport(t, r, o, e, s, i);
                if (l < n) return [a];
                if (h === d) {
                  let t = l / c;
            ...
            return (m = (m = m.concat(
              fitCubic(t.slice(0, h + 1), e, p, n, i),
            )).concat(fitCubic(t.slice(h), g, s, n, i)));
          }
          ...
          function reparameterize(t, e, s) {
            return s.map((s, n) => newtonRaphsonRootFind(t, e[n], s));
          }
          function newtonRaphsonRootFind(t, e, s) {
            var n = maths.subtract(bezier.q(t, s), e),
              ...
              r =
                maths.sum(maths.squareItems(i)) +
                2 * maths.mulMatrix(n, bezier.qprimeprime(t, s));
            return 0 === r ? s : s - a / r;
          }
          var mapTtoRelativeDistances = function (t, e) {
            ...
            return (n = n.map((t) => t / a));
          };
          function find_t(t, e, s, n) {
            if (e < 0) return 0;
            if (e > 1) return 1;
            for (var i, a, r, o, l = 1; l <= n; l++)
              if (e <= s[l]) {
                r = (l - 1) / n;
                a = l / n;
          ...
          class maths {
            ...
            static mulMatrix(t, e) {
              return t.reduce((t, s, n) => t + s * e[n], 0);
            }
            static subtract(t, e) {
        ...
        (t, e, s) => {
          ...
          class AnnotationElement {
            ...
            _createContainer(t = !1) {
              const { data: e, page: s, viewport: i } = this,
            ...
            setRotation(t, e = this.container) {
              const { pageWidth: s, pageHeight: n } = this.viewport.rawDims,
                { width: i, height: a } = getRectDims(this.data.rect);
              let r, o;
              if (t % 180 == 0) {
                r = (100 * i) / s;
                o = (100 * a) / n;
            ...
            get _commonActions() {
              const setColor = (t, e, s) => {
                const n = s.detail[t];
                s.target.style[e] = r.ColorConverters[`${n[0]}_HTML`](
                  n.slice(1),
                );
              };
            ...
            _getElementsByName(t, e = null) {
              ...
              if (this._fieldObjects) {
                ...
                if (i)
                  for (const { page: t, id: a, exportValues: r } of i) {
                    if (-1 === t) continue;
                    if (a === e) continue;
                    const i = 'string' == typeof r ? r : null,
                      o = document.querySelector(`[data-element-id="${a}"]`);
                    !o || c.has(o)
                      ? s.push({ id: a, exportValue: i, domElement: o })
                      : (0, n.warn)(
              ...
              for (const n of document.getElementsByName(t)) {
                const { exportValue: t } = n,
                  i = n.getAttribute('data-element-id');
                i !== e &&
                  c.has(n) &&
                  s.push({ id: i, exportValue: t, domElement: n });
              }
              return s;
            }
          }
          class LinkAnnotationElement extends AnnotationElement {
                ...
                i &&
                  (t[i] = () => {
                    this.linkService.eventBus?.dispatch(
                      ...
                      { source: this, detail: { id: e.id, name: n } },
                    );
                    return !1;
                  });
              }
            ...
            _bindResetFormAction(t, e) {
              ...
              if (this._fieldObjects)
                t.onclick = () => {
                  s?.();
                  const { fields: t, refs: i, include: a } = e,
                    r = [];
          ...
          class WidgetAnnotationElement extends AnnotationElement {
            ...
            _getKeyModifier(t) {
              const { isWin: e, isMac: s } = n.FeatureTest.platform;
              return (e && t.ctrlKey) || (s && t.metaKey);
            }
            _setEventListener(t, e, s, n) {
              e.includes('mouse')
            ...
            _setEventListeners(t, e, s) {
              for (const [n, i] of e)
                ('Action' === i || this.data.actions?.[i]) &&
                  this._setEventListener(t, n, i, s);
            }
            _setBackgroundColor(t) {
              ...
              t.style.backgroundColor =
                null === e
                  ? 'transparent'
                  : n.Util.makeHexColor(e[0], e[1], e[2]);
            }
            _setTextStyle(t) {
              ...
              if (this.data.multiLine) {
                const t = Math.abs(this.data.rect[3] - this.data.rect[1] - 2),
                  e = t / (Math.round(t / (n.LINE_FACTOR * i)) || 1);
                r = Math.min(i, roundToOneDecimal(e / n.LINE_FACTOR));
              } else {
                const t = Math.abs(this.data.rect[3] - this.data.rect[1] - 2);
                r = Math.min(i, roundToOneDecimal(t / n.LINE_FACTOR));
              }
                ...
                if (this.enableScripting && this.hasJSActions) {
                  ...
                  s.addEventListener('updatefromsandbox', (s) => {
                    const n = {
                      ...
                      formattedValue(s) {
                        const { formattedValue: n } = s.detail;
                        r.formattedValue = n;
                        null != n &&
                  ...
                  s.addEventListener('keydown', (t) => {
                    ...
                    if (r.lastCommittedValue !== n) {
                      r.lastCommittedValue = n;
                      r.userValue = n;
                      this.linkService.eventBus?.dispatch(
                        'dispatcheventinsandbox',
                        {
                  ...
                  this.data.actions?.Keystroke &&
                    s.addEventListener('beforeinput', (t) => {
                      ...
                      const { data: s, target: n } = t,
                        { value: i, selectionStart: a, selectionEnd: o } = n;
                      let l = a,
                        c = o;
                      switch (t.inputType) {
                        case 'deleteWordBackward': {
                          const t = i.substring(0, a).match(/\w*[^\w]*$/);
                          t && (l -= t[0].length);
                          break;
                        }
                        case 'deleteWordForward': {
                          const t = i.substring(a).match(/^[^\w]*\w*/);
                          t && (c += t[0].length);
                          break;
                        }
          ...
          class CheckboxWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              i.addEventListener('change', (n) => {
                const { name: i, checked: a } = n.target;
                for (const n of this._getElementsByName(i, s)) {
                  const s = a && n.exportValue === e.exportValue;
                  n.domElement && (n.domElement.checked = s);
                  t.setValue(n.id, { value: s });
                }
              ...
              if (this.enableScripting && this.hasJSActions) {
                i.addEventListener('updatefromsandbox', (e) => {
                  const n = {
                    value(e) {
          ...
          class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
            ...
            render() {
              ...
              i.addEventListener('change', (e) => {
                const { name: n, checked: i } = e.target;
                for (const e of this._getElementsByName(n, s))
            ...
            render() {
              ...
              if (s) {
                const t = 0.7 * (255 - s[0]) + s[0],
                  i = 0.7 * (255 - s[1]) + s[1],
                  a = 0.7 * (255 - s[2]) + s[2];
                e.style.backgroundColor = n.Util.makeHexColor(
                  0 | t,
                  0 | i,
                  0 | a,
                );
              ...
              e.append(a);
              const r = i.PDFDateString.toDateObject(this.modificationDate);
              if (r) {
          ...
          class FileAttachmentAnnotationElement extends AnnotationElement {
            constructor(t) {
              ...
              this.filename = (0, i.getFilenameFromUrl)(e, !0);
              this.content = s;
          ...
          class AnnotationLayer {
            static #Te(t, e, s, n) {
              ...
              a.id = `${i.AnnotationPrefix}${e}`;
              s.append(t);
              n?.moveElementInDOM(s, t, a, !1);
            }
            static render(t) {
              const {
                annotations: e,
              ...
              let c = 0;
              for (const t of e) {
                if (t.annotationType !== n.AnnotationType.POPUP) {
                ...
                const i = e.render();
                t.hidden && (i.style.visibility = 'hidden');
                if (Array.isArray(i))
                  for (const e of i) {
                    e.style.zIndex = c++;
                    AnnotationLayer.#Te(e, t.id, s, o);
                  }
                else {
                  i.style.zIndex = c++;
                  e instanceof PopupAnnotationElement
                    ? s.prepend(i)
                    : AnnotationLayer.#Te(i, t.id, s, o);
                }
              }
              this.#we(s, t.annotationCanvasMap);
            }
            static update(t) {
              const { annotationCanvasMap: e, div: s, viewport: n } = t;
              (0, i.setLayerDimensions)(s, { rotation: n.rotation });
              this.#we(s, e);
              s.hidden = !1;
            }
            static #we(t, e) {
            ...
            static render(t) {
              ...
              for (; o.length > 0; ) {
                ...
                if (l.children && l.children.length > 0) o.push([l, -1, d]);
                  ...
                  const t = document.createTextNode(l.value);
                  n.XfaText.shouldBuildText(h) && c.push(t);
                  d.append(t);
                }
              }
          ...
          e.SVGGraphics = r;
          {
            const o = {
              ...
              u = (function () {
                ...
                return function convertImgDataToPng(t, e, s) {
                  return encode(
                    t,
                    void 0 === t.kind ? i.ImageKind.GRAYSCALE_1BPP : t.kind,
                    e,
                    s,
                  );
                };
            ...
            e.SVGGraphics = r = class {
              constructor(t, e, s = !1) {
                ...
                for (const t in i.OPS) this._operatorIdMapping[i.OPS[t]] = t;
              }
              getObject(t, e = null) {
                return 'string' == typeof t
                  ? t.startsWith('g_')
                ...
                for (const e of t) {
                  ...
                  switch (0 | s) {
                    ...
                    case 92:
                      ...
                      break;
                    default:
                      (0, i.warn)(`Unimplemented operator ${t}`);
                  }
                }
              }
              setWordSpacing(t) {
              ...
              setTextMatrix(t, e, s, n, i, a) {
                ...
                r.textMatrix = r.lineMatrix = [t, e, s, n, i, a];
              ...
              showText(t) {
                ...
                if (
                  b === i.TextRenderingMode.FILL ||
                  b === i.TextRenderingMode.FILL_STROKE
                ) {
              ...
              endText() {
                const t = this.current;
                if (
                  t.textRenderingMode & i.TextRenderingMode.ADD_TO_PATH_FLAG &&
              ...
              _makeTilingPattern(t) {
                const e = t[1],
                  ...
                  d = t[7],
                  u = 'shading' + m++,
                  [p, g, f, b] = i.Util.normalizeRect([
                    ...i.Util.applyTransform([a, r], n),
                    ...i.Util.applyTransform([o, l], n),
                  ]),
                  [A, _] = i.Util.singularValueDecompose2dScale(n),
                  y = c * A,
                  v = h * _,
                ...
                for (const [e, s] of t)
                  switch (e) {
                    ...
                    case 'ca':
                      ...
                      break;
                    default:
                      (0, i.warn)(`Unimplemented graphic state operator ${e}`);
                  }
              }
              fill() {
                const t = this.current;
              ...
              paintInlineImageXObject(t, e) {
                ...
                r.setAttributeNS(c, 'xlink:href', i);
              ...
              paintFormXObjectBegin(t, e) {
                ...
                if (e) {
                  ...
                  n.setAttributeNS(null, 'x', e[0]);
                  n.setAttributeNS(null, 'y', e[1]);
                  n.setAttributeNS(null, 'width', pf(t));
                  n.setAttributeNS(null, 'height', pf(s));
          ...
          class PDFNodeStreamFullReader extends BaseFullReader {
            constructor(t) {
              ...
              const handleResponse = (e) => {
                if (404 === e.statusCode) {
                  const t = new n.MissingPDFException(
          ...
          class PDFNodeStreamFsFullReader extends BaseFullReader {
            constructor(t) {
              ...
              a.lstat(e, (t, s) => {
                if (t) {
                  'ENOENT' === t.code &&
                    (t = new n.MissingPDFException(`Missing PDF "${e}".`));
                  this._storedError = t;
                  this._headersCapability.reject(t);
                } else {
          ...
          class PDFNodeStreamFsRangeReader extends BaseRangeReader {
            constructor(t, e, s) {
              ...
              this._setReadableStream(
                a.createReadStream(n, { start: e, end: s - 1 }),
              );
            }
          }
        },
        (t, e, s) => {
          ...
          e.createResponseStatusError = function createResponseStatusError(
            ...
            if (404 === t || (0 === t && e.startsWith('file:')))
              return new n.MissingPDFException('Missing PDF "' + e + '".');
          ...
          e.extractFilenameFromHeader = function extractFilenameFromHeader(t) {
            ...
            if (e) {
              let t = (0, i.getFilenameFromContentDispositionHeader)(e);
              if (t.includes('%'))
                try {
        ...
        (t, e, s) => {
          ...
          class NetworkManager {
            ...
            request(t) {
              const e = this.getXhr(),
                s = this.currXhrId++,
                n = (this.pendingRequests[s] = { xhr: e });
              e.open('GET', this.url);
            ...
            onStateChange(t, e) {
              ...
              const r = (function getArrayBuffer(t) {
                ...
                return 'string' != typeof e
                  ? e
                  : (0, n.stringToBytes)(e).buffer;
              })(i);
              if (206 === a) {
                const t = i.getResponseHeader('Content-Range'),
                  e = /bytes (\d+)-(\d+)\/(\d+)/.exec(t);
                s.onDone({ begin: parseInt(e[1], 10), chunk: r });
              } else
                r ? s.onDone({ begin: 0, chunk: r }) : s.onError?.(i.status);
            }
            getRequestXhr(t) {
          ...
          class PDFNetworkStreamFullRequestReader {
            ...
            _onHeadersReceived() {
              const t = this._fullRequestId,
                ...
                { allowRangeRequests: s, suggestedLength: n } = (0,
                i.validateRangeRequestCapabilities)({
                  getResponseHeader: getResponseHeader,
          ...
          class PDFFetchStreamReader {
            constructor(t) {
              ...
              fetch(
                ...
                .then((t) => {
                  if (!(0, i.validateResponseStatus)(t.status))
                    throw (0, i.createResponseStatusError)(t.status, s);
          ...
          class PDFFetchStreamRangeReader {
            constructor(t, e, s) {
              ...
              fetch(
                ...
                .then((t) => {
                  if (!(0, i.validateResponseStatus)(t.status))
                    throw (0, i.createResponseStatusError)(t.status, r);
                  this._readCapability.resolve();
                  this._reader = t.body.getReader();
                })
    ...
    (() => {
      ...
      if (c.isNodeJS) {
        ...
        (0, s.setPDFNetworkStreamFactory)((s) =>
          (0, n.isValidFetchUrl)(s.url) ? new e(s) : new t(s),
        );
      }
    })();
